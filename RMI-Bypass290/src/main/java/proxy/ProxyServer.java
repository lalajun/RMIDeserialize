...
import exceptions.BaRMIeException;
import exceptions.BaRMIeProxyAlreadyStartedException;
import exceptions.BaRMIeProxyStartupException;
	...
	final public void run() {
		...
		while(this._shutdown == false) {
			try {
				...
				targetSock.setSoTimeout(5 * 1000);
